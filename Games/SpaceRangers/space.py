...
pygame.mixer.music.load(os.path.join('assets', 'soundtrack.mp3'))
...
def main():
	...
	def redraw_window():
		WIN.blit(BG, (0,0))
		# Draw text
		lives_label = main_font.render(f"Lives: {LIVE}", 1, (255, 0, 0))
		...
		if lost:
			lost_label = lost_font.render("Жизнь великого рейнджера закончилась!",1, (255, 0, 0))
...
def main_menu():
	...
	while run:
		WIN.blit(BG, (0,0))
		title_label = title_font.render("Press the mouse to begin", 1, (225,255,255))
